...
Now that you've understood the rationale of Agora, you can either [jump straight into using it](../getting-started) or [read the formal specification](./specification.md).
